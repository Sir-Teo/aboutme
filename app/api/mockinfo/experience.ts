...
export default {
    ...
    data: [
      ...
      },
      {
        ...
        Responsibilities:
          'During my tenure at T.M. Bier & Associates, Inc., I served as an AI Software Engineer Intern with a focus on sales data forecasting and full stack development. I developed and optimized machine learning models to predict sales trends, integrating data analytics into the company’s decision-making processes. ',
      },
      {
